...
from concurrent.futures import ThreadPoolExecutor as sadikzssb
from string import * 
...
\033[1;37m Facebook:           মিঁ ব্যাঁচেঁলঁরঁ
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sadikzssb(max_workers=30) as ssbworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
...
def cutter():
    ...
    print(" ")
    sadikz = input('Saving Put File Name :')
    os.system('touch ' +sadikz)
    os.system('sort -r '+ssb+' | uniq > '+sadikz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + ssb )
    print(47*'-')
    print("File Saved To :" + sadikz )
    print(47*'-')
